...
Engine::Rendering::FrameBuffer::FrameBuffer(uint64_t  width, uint64_t  height, const std::shared_ptr<Direct3D>& d3d)
	:m_d3d(d3d)
{
...
void Engine::Rendering::FrameBuffer::SetAsRenderTarget()
{
...
Microsoft::WRL::ComPtr<ID3D11ShaderResourceView> Engine::Rendering::FrameBuffer::GetShaderResourceView()const
{
