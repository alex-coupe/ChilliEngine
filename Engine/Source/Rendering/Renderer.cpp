...
void Engine::Rendering::Renderer::SetUpD3D()
{
	...
	{
		MessageBox(m_handle, L"Failed To Create Swap Chain", L"Chilli Error", MB_ICONWARNING | MB_OK);
	}
...
void Engine::Rendering::Renderer::ShutdownD3D()
{
